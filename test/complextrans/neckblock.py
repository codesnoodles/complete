...
class ConnectTrans(nn.Module):
    ...
    def __init__(self, input_size, output_size, dropout=0, num_layers=4):
    ...
    def forward(self, input):
        #  input --- [b,  c,  num_frames, frame_size]  --- [b, c, dim2, dim1]---[b,64,frames,256]
        b, c, dim2, dim1 = input.shape
        output = self.input(input) # [b,32,frames,256]
        for i in range(len(self.row_trans)):
            ...
            output = output + col_output  # [b, c, dim2, dim1] 残差连接的体现
